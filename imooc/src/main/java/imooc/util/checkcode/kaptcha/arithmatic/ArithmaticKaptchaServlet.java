package imooc.util.checkcode.kaptcha.arithmatic;
...
public class ArithmaticKaptchaServlet extends HttpServlet implements Servlet
{
			...
			throws ServletException, IOException
	{
		...
		req.getSession().setAttribute(this.sessionKeyValue, String.valueOf(result));
